    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="{{ (request()->is('dokter-radiologi/pasien/index/pasien-umum')) ? 'active' : '' }}">
                <a href="{{ route('dokterRadiologi.pasien.index-pasien-umum') }}">
                    <i class="fa fa-users"></i> <span>Pasien Umum</span>
                </a>
            </li>
            <li class="{{ (request()->is('dokter-radiologi/pasien/index/pasien-rs')) ? 'active' : '' }}">
                <a href="{{ route('dokterRadiologi.pasien.index-pasien-rs') }}">
