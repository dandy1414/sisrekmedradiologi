...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <!-- sidebar -->
        @include('layouts.sidebar_resepsionis')
        <!-- /sidebar -->
    ...
    <script>
        ...
        $("#button-one").click(function() {
          ...
          $("#tabelsemuapasien1").show()
          $("#tabelsemuapasien2").hide()
          $("#tabelsemuapasien3").hide()
        })
        $("#button-two").click(function() {
          ...
          $("#button-three").css("background", "#ecf0f5")
          $("#button-three").css("color", "black")
          $("#tabelsemuapasien2").show()
          $("#tabelsemuapasien1").hide()
          $("#tabelsemuapasien3").hide()
        })
