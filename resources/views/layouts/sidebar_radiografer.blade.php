<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ (request()->is('radiografer/pasien/index/pasien-umum')) ? 'active' : '' }}">
          <a href="{{ route('radiografer.pasien.index-pasien-umum') }}">
            <i class="fa fa-users"></i> <span>Pasien Umum</span>
          </a>
        </li>
        <li class="{{ (request()->is('radiografer/pasien/index/pasien-rs')) ? 'active' : '' }}">
          <a href="{{ route('radiografer.pasien.index-pasien-rs') }}">
            <i class="fa fa-users"></i> <span>Pasien RS</span>
          </a>
        </li>
        <li class="{{ (request()->is('radiografer/index/pemeriksaan')) ? 'active' : '' }}">
          <a href="{{ route('radiografer.pasien.index-pemeriksaan') }}">
