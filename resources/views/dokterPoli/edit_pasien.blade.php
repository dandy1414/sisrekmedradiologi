...
@section('title')Edit Pasien @endsection
...
<section class="content-header" style="margin-top: 50px;">
    ...
    <ol class="breadcrumb">
        <li>
            <a href="{{ route('dokterPoli.pasien.index-pasien') }}"><i class="fa fa-users"></i> Pasien</a></li>
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <form method="POST" action="{{ route('dokterPoli.pasien.update-pasien', ['id' => $pasien->id]) }}" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
