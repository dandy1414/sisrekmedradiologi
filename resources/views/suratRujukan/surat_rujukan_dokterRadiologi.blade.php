...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-9">
                @if (request()->is('dokter-poli/*/pendaftaran/detail/*'))

                @else
                    <a class="btn btn-success btn" href="{{ route('dokterRadiologi.pasien.index-pemeriksaan') }}"><i class="fa fa-list"></i> Kembali</a>
                @endif
