                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->first('jenisPasien') ? "has-error": "" }}">
                                    ...
                                    <select onchange="yesnoSelect()" class="form-control select2" name="jenisPasien" style="width: 100%;">
                                        <option id="noSelect" value="umum"
                                            {{ $pasien->jenis_pasien == 'umum' ? "selected" : "" }}>
                                            Umum</option>
                                        <option id="yesSelect" value="rs"
                                            {{ $pasien->jenis_pasien == 'rs' ? "selected" : "" }}>
                                            Rumah sakit</option>
                                    </select>
                                ...
                                <div id="ifYes2" class="form-group {{ $errors->first('asalRuangan') ? "has-error": "" }}" style="display: none">
