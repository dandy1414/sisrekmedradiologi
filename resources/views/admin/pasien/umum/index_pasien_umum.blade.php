...
<section class="content-header" style="margin-top: 50px;">
    ...
    <ol class="breadcrumb" style="margin-top: 58px">
        <li><a href="{{ route('pasien.index-pasien-umum') }}"><i class="fa fa-users"></i> List Pasien Umum</a></li>
    </ol>
</section>
...
<div class="row">
    <div class="col-md-8">
        <div class="btn-group" style="float: left; margin-left: 15px; margin-top: 20px">
            <button class="btn btn-success" onclick="window.location='{{ route('pasien.create.pasien-umum') }}'"><span class="fa fa-user-plus" style="margin-right: 5px"></span>Tambah Pasien</button>
        </div>
                                    ...
                                    <div class="input-group margin">
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="{{ route('pasien.detail-pasien-umum',
