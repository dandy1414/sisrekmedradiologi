...
@section('title')Tambah Pasien Rumah Sakit Baru @endsection

@section('content')
<section class="content-header" style="margin-top: 50px;">
    <h1>
        Tambah Pasien Rumah Sakit Baru
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <form method="POST" action="{{ route('resepsionis.pasien.store.pasien-rs') }}" enctype="multipart/form-data">
                @csrf
